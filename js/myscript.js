...
function esNombreValido() {
    ...
    if (!nombre.match(nombrePattern)) {
        alert("Te has equivocado al escribir el nombre");
...
function espApellidoValido() {
    ...
    if (!pApellido.match(apellidoPattern)) {
        alert("Te has equivocado al escribir el Primer Apellido");
        return validar = false;
    }
}
...
function essApellidoValido() {
    ...
    if (!sApellido.match(apellidoPattern)) {
        alert("Te has equivocado al escribir el Segundo Apellido");
       return validar = false;
    }
}
...
function esTlfValido() {
    ...
    if (!tlf.match(phonePattern)) {
        alert("Te has equivocado al escribir el telefono");
        return validar = false;
    }
}
function esDniValido() {
    ...
    if (!dni.match(DNI_REGEX)) {
        alert("Te has equivocado no es una dni");
        return validar = false;
    }
}
...
function esIbanValido() {
    ...
    if (!iban.match(IBAN_REGEX)) {
        alert("Te has equivocado , no es un iban");
        return validar = false;
    } else {
